...
export function thermal80Css(extra = "") {
  return `@page{size:80mm auto;margin:1.5mm}html,body{margin:0!important;padding:0!important;background:white}.thermal-print{font-family:"Courier New",ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;font-size:11px;line-height:1.25;width:74mm;max-width:74mm;margin:0 auto;color:#111;word-break:break-word}.center{text-align:center!important}.line{border-top:1px dashed #555;margin:5px 0}.row{display:flex;justify-content:space-between;gap:8px}.title{font-weight:800;font-size:15px;line-height:1.15;text-align:center!important}.big,.total{font-weight:700;font-size:13px}.small{font-size:9.5px}.multiline{white-space:pre-line}.item-name{font-weight:600;white-space:normal;word-break:break-word}.qr{width:86px!important;height:86px!important;display:block;margin:5px auto}.logo{max-width:44mm;max-height:20mm;object-fit:contain;display:block;margin:0 auto 5px}img{max-width:100%}@media print{body>*:not(.thermal-print):not(main){display:none!important}.thermal-print{display:block!important}}${extra}`;
}
